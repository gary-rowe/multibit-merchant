package org.multibit.mbm.client.domain.repositories.common;
...
public interface EntityReadService<T> {
  ...
  /**
   * Provide a {@link org.multibit.mbm.client.common.pagination.PaginatedList} list of a subset of the entity
   *
   * @param pageSize   The total entities returned in one page (1-based)
   * @param pageNumber The page number (1-based)
   * @return A {@link org.multibit.mbm.client.common.pagination.PaginatedList} with the entities
   */
   ...
   *
   * @return A {@link org.multibit.mbm.client.common.pagination.PaginatedList} with the matching entities
   */
