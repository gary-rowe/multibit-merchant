...
import org.multibit.mbm.client.domain.repositories.CustomerReadService;
...
public class HibernateCartReadServiceIntegrationTest extends BaseIntegrationTests {

  @Resource(name = "hibernateCartDao")
  private CartReadService testObject;
  ...
  public void testPersist() {
    ...
    Optional<User> user = userReadService.getByApiKey("alice123");
