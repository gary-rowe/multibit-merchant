...
class OpenIdAuthInjectable<T> extends AbstractHttpContextInjectable<T> {
  ...
  OpenIdAuthInjectable(Authenticator<OpenIdCredentials, T> authenticator, String realm, boolean required) {
        ...
        if (space > 0) {
          ...
          if (PREFIX.equalsIgnoreCase(method)) {
            ...
            if (i > 0) {
              ...
              final OpenIdCredentials credentials = new OpenIdCredentials(username,
                password);
