...
/**
 * <p>Value object to provide the following to {@link org.multibit.mbm.interfaces.rest.auth.hmac.HmacAuthenticator}:</p>
 * <ul>
...
public class HmacServerCredentials {
   ...
   * @param requiredAuthorities     The authorities required to authenticate (provided by the {@link org.multibit.mbm.interfaces.rest.auth.annotation.RestrictedTo} annotation)
   */
