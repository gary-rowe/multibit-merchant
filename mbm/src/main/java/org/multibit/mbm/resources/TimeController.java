...
import org.multibit.mbm.api.response.DateTimeResponse;
...
public class TimeController {
   ...
   * Provides the current server time in UTC
   *
   * @return A {@link org.multibit.mbm.api.response.DateTimeResponse} containing the date split into fields
   */
