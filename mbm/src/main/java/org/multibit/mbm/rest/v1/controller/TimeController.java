...
import org.multibit.mbm.rest.v1.client.DateTimeResponse;
...
public class TimeController {
   ...
   * Provides the current server time in UTC
   *
   * @return A {@link org.multibit.mbm.rest.v1.client.DateTimeResponse} containing the date split into fields
   */
